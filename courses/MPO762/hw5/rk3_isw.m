function [uu,vu,etau] = rk3_isw(u,v,eta,dx,dy,dt,f,a,H,g)
	%
	% RK3 Scheme to time steps the variables u, v and eta through a single step of size depth
	%
	% usage is
	% [uu,vu,etau] = rk3_isw(u,v,eta,dx,dy,dt,f,a,H,g)
	%
	...
	r = rhs_isw_umomentum(u,v,eta,dx,dy,a,f,g,H);
	ut1 = u + dt*r;               			    


	r = rhs_isw_vmomentum(u,v,eta,dx,dy,a,f,g,H);
	vt1 = v + dt*r;               			    
	...
	r = rhs_isw_umomentum(ut1,vt1,etat1,dx,dy,a,f,g,H);
	ut2 = 0.75*u + 0.25*(ut1 + dt*r); 		    

	r = rhs_isw_vmomentum(ut1,vt1,etat1,dx,dy,a,f,g,H);
	...
	r = rhs_isw_umomentum(ut2,vt2,etat2,dx,dy,a,f,g,H);
	uu = (u + 2.0*(ut2 + dt*r))/3.0;  		    

	r = rhs_isw_vmomentum(ut2,vt2,etat2,dx,dy,a,f,g,H);
